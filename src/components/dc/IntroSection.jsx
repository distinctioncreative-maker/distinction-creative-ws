        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 100, alignItems: 'start' }}>
          ...
          <div>
            ...
            <h2 className="reveal" style={{
              ...
              letterSpacing: '-0.025em', color: '#F0EEE8', marginBottom: 28,
            }}>
              Not an Agency.<br />
              <span style={{
            ...
            <p className="reveal" style={{
              ...
              color: 'rgba(240,238,232,0.48)', maxWidth: 420, letterSpacing: '0.005em',
            }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, paddingTop: 8 }}>
            {[
              { num: '01', title: 'We Assess Your Stack', body: 'Before any configuration, we map your current tools, workflows, data, and operational gaps.' },
              { num: '02', title: 'We Design Your System', body: 'We architect Distinction OS around your business — integrating what works, evolving what limits you.' },
              { num: '03', title: 'We Install & Operate', body: 'Your system is live, configured, and optimised. Faster, more visible, and running on intelligence.' },
            ].map((item, i) => (
              ...
              >
                <span style={{ fontSize: 10, fontWeight: 800, color: 'rgba(201,168,76,0.4)', fontFamily: 'Inter', letterSpacing: '0.1em', minWidth: 24, marginTop: 2 }}>{item.num}</span>
                <div>
                  <div style={{ fontSize: 15, fontWeight: 700, color: '#F0EEE8', marginBottom: 7, letterSpacing: '-0.01em' }}>{item.title}</div>
                  <div style={{ fontSize: 13, lineHeight: 1.7, color: 'rgba(240,238,232,0.44)' }}>{item.body}</div>
                </div>
              </div>
            ))}
          </div>
